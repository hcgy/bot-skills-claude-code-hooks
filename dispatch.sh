...
RUNNER="/home/dministrator/.openclaw/skills/claude-code-dispatch/scripts/claude_code_run.py"
...
FEISHU_TARGET=""
CALLBACK_SESSION=""
WORKDIR="/home/dministrator/.openclaw"
AGENT_TEAMS=""
TEAMMATE_MODE=""
...
while [[ $# -gt 0 ]]; do
    case "$1" in
        ...
        -f|--feishu) FEISHU_TARGET="$2"; shift 2;;
...
# Set proxy for Anthropic API (WSL2 to Windows host)
...
# Set git proxy
git config --global http.proxy "http://172.22.176.1:4780"
git config --global https.proxy "http://172.22.176.1:4780"
